...
public class InformationExpert {
	...
	public final static int // DEFAULT PLAYER VARIABLES , used in the constructor of Entity 
		PLAYER_DEFAULT_HEALTH = 20, PLAYER_DEFAULT_DAMAGE = 2, PLAYER_DEFAULT_SPEED = 3, PLAYER_DEFAULT_FIRE_RATE = 400	;
	public final static int THREAD_HIT_WAIT_TIME = 1000;
	...
	public final static int BUFF_BLOOD_SEEKER = 1 , BUFF_GUARDIAN_ANGEL = 2, BUFF_TANK = 3 ,
			BUFF_SHARPSHOOTER = 4 , BUFF_AVENGER = 5, BUFF_SPEEDSTER = 6 , BUFF_REPEATER = 7 ,
			BUFF_BERZERKER = 8;
	
	// FOR CHOOSING MAPS
	public final static int MAP_RANDOM = 1,  MAP_PREMADE = 2;
