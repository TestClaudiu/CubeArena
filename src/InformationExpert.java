...
//		= { "BLOOD SEEKER" ,"GUARDIAN ANGEL","TANK", "SHARPSHOOTER" , "AVENGER" , "SPEEDSTER" ,"REPEATER" , "BERZERKER" , "BOT KILLER" , "REFLECTER" ,"NECROMANCER"};// NAME OF BUFFS , used in StartPanel.java draw
	= { "BLOOD SEEKER" ,"GUARDIAN ANGEL","TANK", "SHARPSHOOTER" , "AVENGER" , "SPEEDSTER" ,"REPEATER" , "BERZERKER" , "BOT KILLER" , "REFLECTER" , "GHOST"};// NAME OF BUFFS , used in StartPanel.java draw
